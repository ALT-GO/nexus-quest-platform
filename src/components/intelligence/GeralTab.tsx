...
import { Megaphone, Monitor, Ticket, TrendingUp } from "lucide-react";
import {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader><CardTitle className="text-base font-semibold">Solicitações por Mês</CardTitle></CardHeader>
          <CardContent>
              ...
              <div key={ticket.id} className="flex items-center gap-4 rounded-lg border p-4 transition-colors hover:bg-muted/50">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-1 flex items-center gap-3 text-sm text-muted-foreground">
                    <span>{ticket.id}</span><span>•</span><span>{ticket.date}</span>
                  </div>
                </div>
