...
const recentTickets = [
  ...
  {
    id: "MKT-2024-015",
    title: "Arte para campanha Black Friday",
  ...
  {
    id: "MKT-2024-016",
    title: "Assinatura de e-mail nova",
...
export default function Dashboard() {
  return (
    <AppLayout>
      <PageHeader
        title="Dashboard"
        description="Visão geral do sistema de gestão integrado"
      />
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          value={43}
          description="TI + Marketing"
          icon={Ticket}
          trend={{ value: 12, isPositive: false }}
        />
        <StatCard
          title="Projetos Marketing"
          value={8}
